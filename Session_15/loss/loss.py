...
def model_training(model, original_train_set, test_set, EPOCHS, LEARNING_RATE, BATCH_SIZE, WEIGHT_DECAY, opt, global_step, len_train, len_test, lr_schedule, data_aug):
  """Train the model"""
  t = time.time()
